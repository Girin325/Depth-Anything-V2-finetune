...
parser.add_argument('--dataset', default='hamlyn', choices=['hypersim', 'vkitti', 'hamlyn'])
...
def main():
    ...
    if args.dataset == 'hypersim':
        ...
        trainset = CustomDataset("", transform=transform)
    else:
    ...
    if args.dataset == 'hypersim':
        ...
        valset = CustomDataset("", transform=transform)
    else:
        raise NotImplementedError
